...
// Add Listener
    ...
    public void actionPerformed(ActionEvent ae) {
        double num1 = (double) (Double.parseDouble(txt1.getText()));
        double num2 = (double) (Double.parseDouble(txt2.getText()));
        double ans_plus = num1 + num2;
        double ans_minus = num1 - num2;
        double ans_multipy = num1 * num2;
        double ans_divide = num1 / num2;
        if (ae.getSource().equals(btn1)) {
            txt3.setText(String.valueOf(ans_plus));
        } else if (ae.getSource().equals(btn2)) {
            txt3.setText(String.valueOf(ans_minus));
        } else if (ae.getSource().equals(btn3)) {
            txt3.setText(String.valueOf(ans_multipy));
        } else if (ae.getSource().equals(btn4)) {
           txt3.setText(String.valueOf(ans_divide));
        }
    }
}
